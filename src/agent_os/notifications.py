...
KNOWN_EVENT_TYPES: dict[str, str] = {
    ...
    "workspace_pr_opened": "Pull request opened automatically after successful push.",
    "workspace_pr_failed": "Pull request creation failed after successful push; branch is on remote but no PR exists.",
